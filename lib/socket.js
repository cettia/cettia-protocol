...
module.exports = function(uri, options) {
    ...
    self.close = function() {
        ...
        if (transport) {
            ...
            // If not, this method is called while connecting to the server. It
            // will execute the `stop` function declared in the below
    ...
    self.on("connecting", function() {
        ...
        // a connection is established successfully and `closed` state if a
